...
// VOD endpoints are mounted under /v1/vod — prepend the prefix to every URL here.
export const handlers = (ctx: IExecuteFunctions, baseUrl: string): HandlerMap => {
  const vodBase = `${baseUrl}/vod`;
  return {
    // ── Video ──────────────────────────────────────────────────────────────────
    ...
    'video:get': async (i) => ({
      method: 'GET' as IHttpRequestMethods,
      url: `${vodBase}/videos/${ctx.getNodeParameter('videoId', i) as string}`,
    }),
    ...
    'video:getViewsCount': async () => ({
      method: 'GET' as IHttpRequestMethods,
      url: `${vodBase}/videos/views-count`,
    }),

    'video:clip': async (i) => ({
      method: 'POST' as IHttpRequestMethods,
      url: `${vodBase}/videos/${ctx.getNodeParameter('videoId', i) as string}/clip`,
      headers: { 'Content-Type': 'application/json' },
      body: {
        data: {
    ...
    'video:updatePreview': async (i) => ({
      ...
      url: `${vodBase}/videos/${ctx.getNodeParameter('videoId', i) as string}/preview`,
      headers: { 'Content-Type': 'application/json' },
      body: {
        data: {
    ...
    'mediaAsset:getMany': async (i) => ({
      method: 'GET' as IHttpRequestMethods,
      url: `${vodBase}/media-assets`,
      qs: buildListQs(ctx, i),
    }),

    'mediaAsset:get': async (i) => ({
      method: 'GET' as IHttpRequestMethods,
      url: `${vodBase}/media-assets/${ctx.getNodeParameter('mediaAssetId', i) as string}`,
    }),
    ...
    'mediaAsset:createUploadTicket': async () => ({
      method: 'POST' as IHttpRequestMethods,
      url: `${vodBase}/image-upload-ticket`,
      headers: { 'Content-Type': 'application/json' },
      body: {},
    }),
    ...
    'mediaAsset:updateUploadStatus': async (i) => {
      ...
      return {
        method: 'POST' as IHttpRequestMethods,
        url: `${vodBase}/media-assets/${ctx.getNodeParameter('mediaAssetId', i) as string}/upload-status`,
        headers: { 'Content-Type': 'application/json' },
        body: {
          state: uploadState,
          ...(vendorUploadId ? { vendorUploadId } : {}),
    ...
    'mediaAsset:getCaptions': async (i) => ({
      method: 'GET' as IHttpRequestMethods,
      url: `${vodBase}/media-assets/${ctx.getNodeParameter('mediaAssetId', i) as string}/captions`,
    }),
    ...
    'mediaAsset:updateCaption': async (i) => {
      ...
      return {
        method: 'PUT' as IHttpRequestMethods,
        url: `${vodBase}/media-assets/${ctx.getNodeParameter('mediaAssetId', i) as string}/captions/${ctx.getNodeParameter('languageCode', i) as string}`,
        headers: { 'Content-Type': 'application/json' },
    ...
    'videoPlaylist:getMany': async (i) => ({
      method: 'GET' as IHttpRequestMethods,
      url: `${vodBase}/video-playlists`,
      qs: buildListQs(ctx, i),
    }),

    'videoPlaylist:get': async (i) => ({
      method: 'GET' as IHttpRequestMethods,
      url: `${vodBase}/video-playlists/${ctx.getNodeParameter('playlistId', i) as string}`,
    }),
